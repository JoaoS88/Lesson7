...
////Encapsulates the player’s attributes and actions(attack(), defend(), etc.).
////Handles player - specific actions and interactions with enemies.
//
////Create an Enemy class that :
////Encapsulates the enemy’s attributes and actions.
////Includes basic AI behaviour(attack, defend).
//
////Create a Game class that :
////Manages the entire game flow(game loop, turns).
////Stores and manages multiple Player and Enemy objects.
////Handles interactions between players and enemies.
//
////Refactor the original procedural code into this object - oriented structure by organising the Player, Enemy, and Game classes into separate files(Player.h, Enemy.h, Game.h, and respective.cpp files).
//
////Bonus Task :
////Add functionality for :
////An Item class that players and enemies can use or equip.
////A more complex combat system with random damage variation, item usage, and healing.